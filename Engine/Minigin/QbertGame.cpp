...
void QbertGame::Init()
{
	//Qbert Player1
	const int startHp{ 5 };
	dae::GameObject* Qbert = new dae::GameObject();
	...
	//UI Player1
	dae::GameObject* playerUI = new dae::GameObject();
	...
	dae::InputManager::GetInstance().AddControllerCommand(0, dae::ButtonState::OnPressed, dae::ControllerButton::DPadDown, deathCommand);

	//Score by Controller
	QbertColorChangeCommand* colorCommand = new QbertColorChangeCommand(scoreComponent);
	dae::InputManager::GetInstance().AddControllerCommand(0, dae::ButtonState::OnPressed, dae::ControllerButton::ButtonA, colorCommand);
	QbertCoilyDeathCommand* coilyDeathCommand = new QbertCoilyDeathCommand(scoreComponent);
	dae::InputManager::GetInstance().AddControllerCommand(0, dae::ButtonState::OnPressed, dae::ControllerButton::ButtonB, coilyDeathCommand);
	QbertCaughtSlickSamCommand* caughtSlickSamCommand = new QbertCaughtSlickSamCommand(scoreComponent);
	dae::InputManager::GetInstance().AddControllerCommand(0, dae::ButtonState::OnPressed, dae::ControllerButton::ButtonX, caughtSlickSamCommand);
	QbertRemainingDiscCommand* remainingDiscCommand = new QbertRemainingDiscCommand(scoreComponent);
	dae::InputManager::GetInstance().AddControllerCommand(0, dae::ButtonState::OnPressed, dae::ControllerButton::ButtonY, remainingDiscCommand);
	...
	dae::InputManager::GetInstance().AddControllerCommand(1, dae::ButtonState::OnPressed, dae::ControllerButton::DPadDown, deathCommand);

	//Score by Controller
	colorCommand = new QbertColorChangeCommand(scoreComponent);
	dae::InputManager::GetInstance().AddControllerCommand(1, dae::ButtonState::OnPressed, dae::ControllerButton::ButtonA, colorCommand);
	coilyDeathCommand = new QbertCoilyDeathCommand(scoreComponent);
	dae::InputManager::GetInstance().AddControllerCommand(1, dae::ButtonState::OnPressed, dae::ControllerButton::ButtonB, coilyDeathCommand);
	caughtSlickSamCommand = new QbertCaughtSlickSamCommand(scoreComponent);
	dae::InputManager::GetInstance().AddControllerCommand(1, dae::ButtonState::OnPressed, dae::ControllerButton::ButtonX, caughtSlickSamCommand);
	remainingDiscCommand = new QbertRemainingDiscCommand(scoreComponent);
	dae::InputManager::GetInstance().AddControllerCommand(1, dae::ButtonState::OnPressed, dae::ControllerButton::ButtonY, remainingDiscCommand);
