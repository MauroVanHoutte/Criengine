...
void dae::InputManager::AddKeyboardCommand(ButtonState buttonState, int button, Command* command)
{
...
void dae::InputManager::AddControllerCommand(unsigned controllerId, dae::ButtonState buttonState, dae::ControllerButton button, Command* command)
{
	std::pair<std::pair<unsigned, std::pair<dae::ButtonState, dae::ControllerButton>>, Command*> pair;
